...
public class ServerMain {
    ...
    private static BuyStopOrder buyStopOrder;
    private static SellStopOrder sellStopOrder;
    ...
    public static void main(String[] args) {
        ...
        buyStopOrder = new BuyStopOrder(orderbook, price);
        sellStopOrder = new SellStopOrder(orderbook, price);


        // Prendo l'ultimo id registrato
        int orderId = Math.max(
            Math.max(buyStopOrder.getBuyStopOrderId(), sellStopOrder.getSellStopOrderId()),
        ...
        workerPool.execute(buyStopOrder);
        workerPool.execute(sellStopOrder);
        ...
        try {
            ...
            while (running.get()) {
                try {
                    ...
                    ConnectionHandler connectionHandler = new ConnectionHandler(clientSocket, running, userManager, orderbook, buyStopOrder, sellStopOrder, orderid, storicoOrdiniHandler);
