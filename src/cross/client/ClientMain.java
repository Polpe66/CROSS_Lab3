...
public class ClientMain {
    ...
    public void startClient() {
        ...
        try {
            ...
            ConsoleManager.print("> Connessione Avviata con il server " + InetAddress.getByName(SERVER).getHostAddress() + " sulla porta " + SERVER_PORT);
